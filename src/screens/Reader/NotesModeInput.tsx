...
export interface NotesModeInputHandle {
  focusInput: () => void;
}

export const NotesModeInput = forwardRef<NotesModeInputHandle, Props>(
  function NotesModeInput({ book, fullWidth }, ref) {
    ...
    return (
      ...
      >
        ...
        <div
          className={
            fullWidth
              ? 'flex items-center gap-3 rounded-full border border-amber-100/70 bg-white/80 px-4 py-3 shadow-lg'
...
function focusWithoutScroll(input: HTMLInputElement | null): void {
  if (!input) return;
